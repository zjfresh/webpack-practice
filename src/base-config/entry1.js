...
const { subAsync } = require('@/base-config/files-lib/sub_async')
// const lib = require('./lib'); // 如果有这行引用，与入口2共同引用，则会被抽到 common
require('@/base-config/files-lib/normal3') // 当入口1这里也引用（入口2先单独引用），则在common split的规则下，被归到common Chunk中
